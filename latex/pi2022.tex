...
\begin{frame}
  \begin{figure}
    	\subimport{\tmpDataFolder}{\escapeFromCircleTex}
  \end{figure}
\end{frame}

\begin{frame}
  \begin{figure}
    	\subimport{\tmpDataFolder}{\escapeFromCircleFixedTex}
  \end{figure}
\end{frame}
...
\begin{frame}
  \begin{figure}
    	\subimport{\tmpDataFolder}{\escapeFromRectangleTex}
  \end{figure}
\end{frame}

\begin{frame}
  \begin{figure}
    	\subimport{\tmpDataFolder}{\escapeFromFreeSquareTex}
  \end{figure}
\end{frame}
