...
\begin{column}{0.25\textwidth}
  \begin{figure}
    	\subimport{\tmpDataFolder}{\escapeFromCirclePointTex}
  \end{figure}
\end{column}
\begin{column}{0.25\textwidth}
  \begin{figure}
    	\subimport{\tmpDataFolder}{\escapeFromCircleShiftTex}
  \end{figure}
\end{column}
\begin{column}{0.25\textwidth}
  \begin{figure}
...
\begin{column}{0.25\textwidth}
  \begin{figure}
    	\subimport{\tmpDataFolder}{\escapeFromRectanglePointTex}
  \end{figure}
\end{column}
\begin{column}{0.25\textwidth}
  \begin{figure}
    	\subimport{\tmpDataFolder}{\escapeFromRectangleShiftTex}
  \end{figure}
\end{column}
\begin{column}{0.25\textwidth}
  \begin{figure}
...
\begin{frame}
  \begin{figure}
    	\subimport{\tmpDataFolder}{\escapeFromHalfplaneTex}
  \end{figure}
\end{frame}
...
\begin{frame}
  \begin{figure}
    	\subimport{\tmpDataFolder}{\escapeFromStripTex}
  \end{figure}
\end{frame}
