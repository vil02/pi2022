"""test of common_math_functions module"""
import numpy
import pytest
import common_math_functions as cmf
...
def test_zero_angle_rotation_is_identity():
    ...
    """
    assert (cmf.calculate_rotation_matrix_2d(0) == numpy.identity(2)).all()
...
def test_rotation_matrix_has_determinant_1(cur_angle):
    ...
    """
    assert numpy.linalg.det(cmf.calculate_rotation_matrix_2d(cur_angle)) == 1
...
def test_composition_of_rotations(angle_a, angle_b):
    ...
    composition_of_rotations = \
        cmf.calculate_rotation_matrix_2d(angle_a) @ \
        cmf.calculate_rotation_matrix_2d(angle_b)
    rotation_by_sum = cmf.calculate_rotation_matrix_2d(angle_a+angle_b)
...
def test_rotate_by_negative_angle(cur_angle):
    ...
    assert numpy.allclose(
        cmf.calculate_rotation_matrix_2d(-cur_angle),
        cmf.calculate_rotation_matrix_2d(2*numpy.pi-cur_angle))
...
def test_rotation_matrix_90_deg():
    ...
    """
    assert numpy.allclose(
        cmf.calculate_rotation_matrix_2d(numpy.radians(90)),
        numpy.array([[0, -1], [1, 0]]))


def test_rotate_2d():
    """checks the result of rotate_2d([1, 0], numpy.radians(90))"""
    assert numpy.allclose(cmf.rotate_2d([1, 0], numpy.radians(90)), [0, 1])
